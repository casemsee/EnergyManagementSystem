...
class InputCheckShortTerm():
    def model_local_check(*args):
        ...
        if type(model["UG"]["STATUS"]) is not int and type(model["UG"]["STATUS"]) is not float and type(model["UG"]["STATUS"]) is not bool:
        ...
        if type(model["DG"]["STATUS"]) is not int and type(model["DG"]["STATUS"]) is not float and type(model["DG"]["STATUS"]) is not bool:
        ...
        if type(model["Load_nac"]["STATUS"]) is not int and type(model["Load_nac"]["STATUS"]) is not float and type(model["Load_nac"]["STATUS"]) is not bool:
        ...
        if type(model["Load_ndc"]["STATUS"]) is not int and type(model["Load_ndc"]["STATUS"]) is not float and type(model["Load_ndc"]["STATUS"]) is not bool:
