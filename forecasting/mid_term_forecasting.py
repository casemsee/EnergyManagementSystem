...
from modelling.database.database_format import db_mid_term_forecasting,five_minutes_history_data
...
def middle_term_forecasting_load_nac_history(*args):
    # Short term forecasting for non-critical AC load
    session = args[0]
    session_source = args[1]
    Target_Time = args[2]
...
def middle_term_forecasting_load_ndc_history(*args):
    # Short term forecasting for non-critical DC load
    session = args[0]
    session_source = args[1]
    Target_Time = args[2]
